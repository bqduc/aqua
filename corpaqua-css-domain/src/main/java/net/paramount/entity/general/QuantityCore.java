 ...
 */
@Embeddable
public class QuantityCore implements java.io.Serializable {
	/**
	* 
	*/
	...
	public QuantityCore(QuantityCore quantity) {
		this.value = new Double(quantity.getValue());
		this.unitId = quantity.getUnitId();
	}

	public QuantityCore(double value, Long unitId) {
		this.value = value;
		this.unitId = unitId;
	}

	public void moveFieldsOf(QuantityCore anotherQuantity) {
